...
import com.codesimcoe.newtonparticlesfx.FluidParticlesAppValueRecord.Particle;
...
public class FluidParticlesAppRecord extends Application {
    ...
    record Particle(float x, float y, float vx, float vy) {
